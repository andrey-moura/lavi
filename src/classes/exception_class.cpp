...
void create_no_function_error_class()
{
  ...
  lavi::lang::no_function_error_class->instance_functions["init"] = std::make_shared<lavi::lang::function>("init", std::initializer_list<std::string>{"message"}, [](lavi::lang::interpreter* interpreter) {
...
void create_undefined_class_error_class()
{
  ...
  lavi::lang::undefined_class_error_class->instance_functions["init"] = std::make_shared<lavi::lang::function>("init", std::initializer_list<std::string>{"message"}, [](lavi::lang::interpreter* interpreter) {
    interpreter->current_context->self->variables["message"] = interpreter->current_context->positional_params[0];
    return nullptr;
  });
